...
router.get('/candidates', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    yield candidateController.getAllCandidates(req, res);
}));
// Route to get a candidate by email
router.get('/candidates/:email', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    yield candidateController.getCandidateByEmail(req, res);
}));
